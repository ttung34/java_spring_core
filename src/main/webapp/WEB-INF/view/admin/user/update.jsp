                            ...
                            <div class="container-fluid px-4">
                                ...
                                <div class="container" style="max-width: 400px; font-family: Arial, sans-serif;">
                                    <div class="mt-5 p-4 border rounded">
                                        ...
                                        <form:form action="/admin/user/update" method="post" modelAttribute="currentUser" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <form:select path="role.id" class="form-select" var="role">
                                                    <form:option items="${role}" value="3">ADMIN</form:option>
                                                    <form:option items="${role}" value="4">USER</form:option>
                                                </form:select>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Current Avatar</label><br />
                                                <c:if test="${not empty currentUser.avatar}">
                                                    <img src="/uploads/avatar/${currentUser.avatar}" alt="Current Avatar"
                                                        style="max-height: 200px; border: 1px solid #ccc; border-radius: 5px;" />
                                                </c:if>
                                            ...
                                            <div class="mb-3 col-6 ">
                                                ...
                                                <input type="file" class="form-control" id="avatarFile" accept=".png, .jpg, .jpeg" name="fileImg" />
                                            </div>
